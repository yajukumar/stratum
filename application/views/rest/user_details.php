<?php
StmFactory::getSession()->set('breadcrumbs', array('Home' => '#', 'Admin' => '#' ,'Name' => '' ));
...
<!-- <stmmessage> -->
<form  autocomplete="off" id="UserProfileForm" name="UserProfileForm" method="post" action="?view=admin&action=saveUser"  >
    	<!--HEADER-->
